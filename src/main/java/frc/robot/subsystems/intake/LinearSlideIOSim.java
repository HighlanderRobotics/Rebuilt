...
public class LinearSlideIOSim extends LinearSlideIO {
    ...
    ElevatorSim physicsSim = new ElevatorSim(null, null, getSetpointMeters(), getSetpointMeters(), false, getSetpointMeters());
    ...
    public LinearSlideIOSim(int motorId, CANBus canBus, TalonFXConfiguration config) {
        ...
        notifier = new Notifier(() -> {
            ...
            talonSim.setRawRotorPosition(physicsSim.getPositionMeters() * 1.0); // TODO: GEAR RATIO
            talonSim.setRotorVelocity(physicsSim.getVelocityMetersPerSecond() * 1.0); // TODO: GEAR RATIO
        });
