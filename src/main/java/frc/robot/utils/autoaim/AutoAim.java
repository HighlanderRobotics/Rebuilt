...
public class AutoAim {
  ...
  static { // For hub shot tree
    ...
    COMP_HUB_SHOT_TREE.put(
        Units.inchesToMeters(24 * Math.sqrt(2) + 6 + 12),
        new ShotData(Rotation2d.fromDegrees(25), 35 
        // - 6
        , 1.14));

    COMP_HUB_SHOT_TREE.put(
        Units.inchesToMeters(24 * Math.sqrt(2) + 6 + 3 * 12),
        new ShotData(Rotation2d.fromDegrees(26), 37 
        // - 6
        , 1.10));

    COMP_HUB_SHOT_TREE.put(
        Units.inchesToMeters(24 * Math.sqrt(2) + 6 + 5 * 12),
        new ShotData(Rotation2d.fromDegrees(30), 37 
        // - 6
        , 1.09));

    COMP_HUB_SHOT_TREE.put(
        Units.inchesToMeters(24 * Math.sqrt(2) + 6 + 7 * 12),
        new ShotData(Rotation2d.fromDegrees(33), 37 
        // - 6
        , 1.15));

    COMP_HUB_SHOT_TREE.put(
        Units.inchesToMeters(24 * Math.sqrt(2) + 6 + 9 * 12),
        new ShotData(Rotation2d.fromDegrees(36), 38 
        // - 6
        , 1.23));

    COMP_HUB_SHOT_TREE.put(
        Units.inchesToMeters(24 * Math.sqrt(2) + 6 + 11 * 12),
        new ShotData(Rotation2d.fromDegrees(38), 39 
        // - 6
        , 1.33));
    COMP_HUB_SHOT_TREE.put(
        Units.inchesToMeters(24 * Math.sqrt(2) + 6 + 13 * 12),
        new ShotData(Rotation2d.fromDegrees(39), 40.5 
        // - 6
        , 1.35));
  }
  ...
  static { // For feed shot tree
    FEED_SHOT_TREE.put(
        Units.feetToMeters(2), new ShotData(Rotation2d.fromDegrees(23.16), 20 , 0)); // - 2, 0));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(4), new ShotData(Rotation2d.fromDegrees(30), 40 , 0.0)); //- 2, 0.0));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(6), new ShotData(Rotation2d.fromDegrees(40), 30, 0.0)); //- 2, 0.0));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(8), new ShotData(Rotation2d.fromDegrees(40), 32, 0.0)); //- 2, 0.0));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(10), new ShotData(Rotation2d.fromDegrees(40), 35, 0.0)); // - 2, 0.0));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(12), new ShotData(Rotation2d.fromDegrees(40), 40, 0.0)); // - 2, 0.0));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(14), new ShotData(Rotation2d.fromDegrees(45), 38, 0.0));// - 2, 0.0));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(16), new ShotData(Rotation2d.fromDegrees(45), 40, 0.0));// - 2, 0.0));

    FEED_SHOT_TREE.put(
        Units.feetToMeters(18), new ShotData(Rotation2d.fromDegrees(40), 38, 1.42)); //- 2, 1.42));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(20), new ShotData(Rotation2d.fromDegrees(43), 40, 1.36)); // - 2, 1.36));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(22), new ShotData(Rotation2d.fromDegrees(45), 41, 1.34)); // - 2, 1.34));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(24), new ShotData(Rotation2d.fromDegrees(47), 42 , 1.25)); //- 2, 1.25));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(26), new ShotData(Rotation2d.fromDegrees(48), 43, 1.28));// - 2, 1.28));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(28), new ShotData(Rotation2d.fromDegrees(49), 45, 1.27));// - 2, 1.27));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(30), new ShotData(Rotation2d.fromDegrees(49), 46, 1.32)); // - 2, 1.32));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(32), new ShotData(Rotation2d.fromDegrees(49), 48, 1.4)); // - 2, 1.4));

    FEED_SHOT_TREE.put(
        Units.feetToMeters(34), new ShotData(Rotation2d.fromDegrees(52), 49, 1.3)); // - 2, 1.3));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(36), new ShotData(Rotation2d.fromDegrees(53), 53, 1.33));//- 2, 1.33));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(38), new ShotData(Rotation2d.fromDegrees(53), 57, 1.3));// - 2, 1.3));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(40), new ShotData(Rotation2d.fromDegrees(55), 57, 1.2));// - 2, 1.2));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(42), new ShotData(Rotation2d.fromDegrees(56), 59, 1.2)); // - 2, 1.2));
