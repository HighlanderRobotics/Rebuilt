...
public class AutoAim {
  ...
  public static int fudgeFactor = 0;
  ...
  static {
    COMP_HUB_SHOT_TREE.put(
        ...
        new ShotData(
            ...
            30 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            0.8));
    COMP_HUB_SHOT_TREE.put(
        2.017596,
        new ShotData(
            Rotation2d.fromDegrees(23 - 13.16),
            33 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            0.9));
    COMP_HUB_SHOT_TREE.put(
        2.423868,
        new ShotData(
            Rotation2d.fromDegrees(25 - 13.16),
            35 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.1));
    COMP_HUB_SHOT_TREE.put(
        2.664198,
        new ShotData(
            Rotation2d.fromDegrees(26 - 13.16),
            36 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.2));
    COMP_HUB_SHOT_TREE.put(
        2.903207,
        new ShotData(
    ...
    COMP_HUB_SHOT_TREE.put(
        ...
        new ShotData(
            ...
            34 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.24));
    COMP_HUB_SHOT_TREE.put(
        3.773999,
        new ShotData(
    ...
    COMP_HUB_SHOT_TREE.put(
        ...
        new ShotData(
            ...
            34.5 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.15));
    COMP_HUB_SHOT_TREE.put(
        4.893493,
        new ShotData(
    ...
    COMP_HUB_SHOT_TREE.put(
        ...
        new ShotData(
            ...
            35.5 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.17));
  }
  ...
  static { // For feed shot tree
    ...
    FEED_SHOT_TREE.put(
        ...
        new ShotData(
            Rotation2d.fromDegrees(43 - 13.16),
            38 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.36)); // - 2, 1.36));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(22),
        new ShotData(
            Rotation2d.fromDegrees(45 - 13.16),
            39 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.34)); // - 2, 1.34));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(24),
        new ShotData(
            Rotation2d.fromDegrees(47 - 13.16),
            40 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.25)); // - 2, 1.25));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(26),
        new ShotData(
            Rotation2d.fromDegrees(48 - 13.16),
            41 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.28)); // - 2, 1.28));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(28),
        new ShotData(
            Rotation2d.fromDegrees(49 - 13.16),
            43 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.27)); // - 2, 1.27));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(30),
        new ShotData(
            Rotation2d.fromDegrees(49 - 13.16),
            44 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.32)); // - 2, 1.32));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(32),
        new ShotData(
            Rotation2d.fromDegrees(49 - 13.16),
            46 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.4)); // - 2, 1.4));
    ...
    FEED_SHOT_TREE.put(
        ...
        new ShotData(
            ...
            47 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.3)); // - 2, 1.3));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(36),
        new ShotData(
            Rotation2d.fromDegrees(53 - 13.16),
            51 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.33)); // - 2, 1.33));
    FEED_SHOT_TREE.put(
        Units.feetToMeters(38),
        new ShotData(
            Rotation2d.fromDegrees(53 - 13.16),
            55 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.3)); // - 2, 1.3));
    FEED_SHOT_TREE.put(
    ...
    FEED_SHOT_TREE.put(
        ...
        new ShotData(
            ...
            57 * 0.84615384615 / TurretSubsystem.FLYWHEEL_GEAR_RATIO + 1 + fudgeFactor,
            1.2)); // - 2, 1.2));
