...
public class Pitcheck {
  ...
  BooleanSupplier intakeRest = 
        ()-> intake.getRollerVoltage()==0;



  public void pitcheck(Subsystem subsystem, Command command, BooleanSupplier endState) {
    SmartDashboard.putData("intakeRoller", new SequentialCommandGroup(
    ...
    SmartDashboard.putData("spindexer", new SequentialCommandGroup(
        pitCheck(spindexer, spindexer.kick(),spindexerKick)));
  }
