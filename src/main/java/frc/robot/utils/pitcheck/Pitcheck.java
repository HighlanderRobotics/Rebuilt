...
public class Pitcheck {
  ...
  // BooleanSupplier intakeRunningForward = () -> MathUtil.isNear(7.0, intake.getRollerVoltage(),
  // 1.0);
  ...
  public static Command pitCheck(Command command, BooleanSupplier endstate) {
